...
<body>
    ...
    <ul style="text-align: center; padding: 0; list-style-type: none;">
        ...
        <li style="display: inline-block; margin: 0 10px;"><a href="index.php" style="text-decoration: none; color: black;" >Logout</a></li>
    </ul>
    <br>
    <p style="text-align: center;">Anda telah berhasil login</p>
    <br>
